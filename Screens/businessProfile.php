    ...
    <div class="mainContainer">
                ...
                <div class="menu">
                    <table cellspacing="20px">
                        ...
                        <tr>
                            ...
                            <td><a href="businessProfile.php" >Profile</a></td>
                        </tr>
                        <tr>
            ...
            <div class="rightContainer">
                <div class="profileContent">
                    ...
                    <!--display business's profile details in a table-->
                    <form action="">
                    ...
                    <!--edit profile button-->
                    <button type="button" class="editProfileButton" onclick="window.location.href='businessEditProfile.php'">Edit Profile</button>
